  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6 px-4 py-10 sm:px-8">
      <header className="text-center">
        ...
        <p className="text-xs text-gold">Table {state.code} closed</p>
      ...
      {!isHost && rematchCode && (
        <section className="rounded-3xl border border-gold/50 bg-gold/10 p-5 text-center">
          <p className="text-xs text-gold">Rematch</p>
      ...
      <Link href="/" className="text-center text-sm text-muted underline underline-offset-4">Leave table</Link>
    </main>
  );
}
