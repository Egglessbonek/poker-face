 ...
 * TODO(phase 3): wire createCursorTracker() to onPointerMove / hover per button.
 */
...
export default function ActionBar({ legal, bounds, pot, disabled, onAct }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-felt-edge p-3" data-actionbar>
      {sizing && bounds && (
