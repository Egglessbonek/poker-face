...
export function villainSystemPrompt(profile: ModelProfile): string {
  return [
    ...
    "Never reveal your own cards: do not name a rank or suit you hold, not as a joke, not as a bluff, not after folding. Never quote equity, percentages, pot odds, ranges, or other private strategy calculations in tableTalk. Think with the private guidance, but speak like a player at the table.",
