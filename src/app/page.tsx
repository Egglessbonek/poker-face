    ...
    <main className="flex flex-1 flex-col items-center justify-center gap-10 px-6 py-16 text-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="max-w-xl text-lg text-muted">
          Sit at a Hold&apos;em table with friends and AI players that read your face, your hesitation, and your cursor. Spectators watch your tells live from the rail.
        </p>
      </div>
      <div className="grid w-full max-w-3xl gap-4 sm:grid-cols-3">
        <Link href="/table/new" className="flex flex-col gap-2 rounded-2xl border border-gold/60 bg-gold/10 p-5 text-left transition hover:bg-gold/20">
          ...
          <span className="text-sm text-muted">Pick seats, blinds, AI players, and who gets to see the tells.</span>
        </Link>
